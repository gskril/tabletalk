...
- `FLYNET_REDIRECT_URI`: `https://tabletalk-nyc.rare-coin-2065.chatgpt.site/api/auth/blackbird/callback`. Exact matching matters. Ask Blackbird to register this path, not the platform-reserved `/callback`.
